...
apply_fonction() {
    ...
    taskset -c 1 ./dotprod "$n" "$r" > "$dir_name/dotprod_${compiler}_${oflag}.dat"
    check_file "$dir_name/dotprod_${compiler}_${oflag}.dat"
    until [ $? -eq 0 ]; do
        taskset -c 1 ./dotprod "$n" "$r" > "$dir_name/dotprod_${compiler}_${oflag}.dat"
        check_file "$dir_name/dotprod_${compiler}_${oflag}.dat"
    done
    cat "$dir_name/dotprod_${compiler}_${oflag}.dat"
}
